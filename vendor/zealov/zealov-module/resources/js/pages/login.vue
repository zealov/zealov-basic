            ...
            <el-col :xs="24" :sm="24" :md="12">
              <div class="login-wrapper">
                ...
                <div class="account-login">
                  <div class="change-code" @click="isCodeLogin = true">
                    <el-tooltip
                      class="item"
                      effect="dark"
                      content="扫码登录"
                  ...
                  <el-tabs v-model="activeTab">
                    ...
                    <el-tab-pane label="账号密码登录" name="accountLogin">
                      ...
                      >
                        ...
                        <el-form-item class="captcha-item" prop="code" :error="error.code ? error.code[0] : ''">
                          <el-input
                        ...
                        <el-form-item>
                          <el-button :loading="loading" type="primary" plain @click="userLogin">
                            立即登录
                          </el-button>
                        </el-form-item>
                      </el-form>
  ...
  methods: {
    ...
    handleLogin () {
      ...
      login(this.loginForm).then((response) => {
        ...
        this.$store.dispatch('auth/saveToken', { token: response.data.access_token })
